...
elseif strcmp(bayes_inputs.data_type,'modis') == true
    ...
    bayes_inputs.num_observations = 7; % hard code this for now, because I don't have any easy way to read in the number of modis bands. When I fix the modis structure to have one EV data cube, I can hard code this in
    %bayes_inputs.num_observations = length(data_struct.EV.bands.number); % number of spectral channels, for this application
